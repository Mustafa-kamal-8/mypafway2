            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-600 mb-4">
                  Mypafway's mission is to ensure the competitiveness of the
                  auto parts industry, so that consumers have choice of auto
                  parts, receive quality auto parts, at competitive prices.
                  Utilizing our website will not only help the auto parts
                  industry, but redraw the auto parts industry structure in a
                  way that spurs enormous growth by allowing companies to
                  promote auto part inventory that has never before been
                  commercially viable. Mypafway enables companies to market
                  their auto part content through our search engine
                  applications. We plan on positioning Mypafway as the preferred
                  brand for comparison shopping of auto parts and accessories
                  online; by focusing company efforts on building brand value,
                  satisfying customers with unparalleled service, convenience
                  and responsiveness; through state-of-the-art applications.
                </p>
                <div className="mb-16">
